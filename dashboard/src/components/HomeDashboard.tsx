...
export function HomeDashboard() {
  ...
  return (
    <div className="flex flex-col gap-12">
      <header>
        <p className="font-sans text-[11px] font-medium uppercase tracking-[0.12em] text-muted">§ 0 — Today's edition</p>
        <h1 className="mt-2 font-serif text-5xl font-semibold leading-tight text-ink sm:text-6xl">
          Welcome back.
        </h1>
        <p className="mt-4 max-w-2xl font-serif text-lg leading-8 text-muted">
          Your assistant's working memory. Here's what's accumulated lately, and where to go next.
        </p>
      </header>
