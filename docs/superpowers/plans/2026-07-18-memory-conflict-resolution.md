...
- [ ] **Step 4: Run the schema test and full API suite**
...
- [ ] **Step 3: Extend the prompt, parser, and persistence path**
...
- [ ] **Step 4: Snapshot automatic updates**
...
- [ ] **Step 3: Add Pydantic contracts and memory service functions**
...
- [ ] **Step 1: Add a failing dashboard contract check**
...
- [ ] **Step 4: Add the review component and workspace integration**
...
- [ ] **Step 2: Run all dashboard checks**
...
- [ ] **Step 3: Review scope and cost impact**
