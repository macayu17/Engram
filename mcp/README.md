...
MCP server for [Engram](https://github.com/macayu17/engram), a self-hostable AI memory layer. Exposes memory search, add, update, delete, list, retrieval logs, and conversation capture as MCP tools.
...
Transport can also be set with `--transport stdio|sse`.
